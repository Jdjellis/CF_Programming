...
> Generated by `cfprog-week --adjust <day> <readiness>`. AMBER keeps each
> PROTECT top set and trims back-off; ACCESSORY/SKILL are flagged flex
> (strength is priority #1). RED drops loaded work to recovery; SKILL survives
> and ACCESSORY degrades to rehab/mobility only.
...
- **[🔴 PUSH (PROTECT)]** Strict Press strength  ·  Front Squat / Strict Press Strength  _(press)_
  ...
  - **Strict Press** — 2 x 5 @ 75% of 1RM<br>    ↳ `52.5 kg` (75% of 70) — per side: 15 + 1.25
...
- **[🟣 ACCESSORY (support — flex)]** Quad / knee supporting work  ·  Front Squat / Strict Press Strength  _(heavy_squat)_
  ...
  - ⚠ _RED: keep rehab / mobility only (e.g. Spanish-squat holds, knee work); skip the loaded split / zombie squats._
